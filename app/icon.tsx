...
export default function Icon() {
  const tileSize = Math.round(size.width * 0.7);
  const iconSize = Math.round(size.width * 0.42);
      ...
      >
        <div
          style={{
            width: tileSize,
            height: tileSize,
            borderRadius: Math.round(tileSize * 0.35),
            backgroundColor: "#3b82f6",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            boxShadow: "0 40px 80px rgba(59, 130, 246, 0.35)",
          }}
        >
          <svg
            aria-hidden="true"
